...
#Connecting YouTube
api_key = 'AIzaSyBzxiXl2gqINqWQ1o2ZMwURkGPv8WUBj_k' # https://console.cloud.google.com/apis/credentials?project=youtube-api-project-386610
youtube = build('youtube', 'v3', developerKey=api_key)

##Connecting MongoDB 
conn1=pymongo.MongoClient("mongodb+srv://iam_sandeep_r:rsandeep@cluster0.p8sldxv.mongodb.net/?retryWrites=true&w=majority") # https://cloud.mongodb.com/v2/64338cc513c80f7e8be73db8#/clusters
db = conn1["Youtube"] 
coll = db["Details"]


#Connecting SQL
conn=psycopg2.connect(host='localhost', user='postgres', password='sandeep', port=5432, database='Youtube')
cursor=conn.cursor()
